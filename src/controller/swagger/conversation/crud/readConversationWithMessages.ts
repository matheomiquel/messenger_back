import { ConversationWithMessagesResponse, GetPagination } from "@controller/schema";
import {
...
const readConversationWithMessagesSwagger = {
  ...
  responses: {
    200: { ...formattingBody({ description: "return conversation with users", schema: ConversationWithMessagesResponse }) },
...
export { readConversationWithMessagesSwagger };
