...
import { UserHelper, ConversationHelper, reset } from '@test/helper';
...
describe('conversation module', () => {
    describe('create conversation', () => {
        it('create conversation', async () => {
            ...
            const createdConversation = await conversationHelper.create({ ...conversationData, token: createdUser.body.token })
    ...
    describe('update conversation', () => {
        it('update conversation with admin of the conversation', async () => {
            ...
            const createdUser = await userHelper.register(userData);
            const conversationCreated = await conversationHelper.create({ ...conversationData, token: createdUser.body.token })
